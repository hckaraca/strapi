"use strict";(self.webpackChunkstrapi_cms_test=self.webpackChunkstrapi_cms_test||[]).push([[1272],{40216:(rt,U,s)=>{s.d(U,{S:()=>$});var t=s(92132),_=s(79793),p=s(94061),X=s(48653),m=s(83997),S=s(30893);const F=(0,_.default)(p.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
