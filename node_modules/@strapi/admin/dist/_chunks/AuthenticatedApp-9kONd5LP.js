...
const LeftMenu = ({ generalSectionLinks, pluginsSectionLinks }) => {
  ...
  const logout = index.useAuth("Logout", (state) => state.logout);
...
const CM = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./index-WJOOvkDD.js")).then((n) => n.App).then((mod) => ({ default: mod.App }))
);
const HomePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./HomePage-YJFJpQMu.js")).then((mod) => ({
    default: mod.HomePage
  }))
);
const InstalledPluginsPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./InstalledPluginsPage-yQJCBWcd.js")).then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage
  }))
);
const MarketplacePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./MarketplacePage-HXV33aGR.js")).then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./index-WJOOvkDD.js")).then((n) => n.NotFoundPage).then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
...
const ProfilePage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./ProfilePage-HNl8o56h.js")).then((mod) => ({
    default: mod.ProfilePage
  }))
);
const SettingsPage = React__namespace.lazy(
  () => Promise.resolve().then(() => require("./SettingsPage-mAb9sKT9.js")).then((mod) => ({
...
const AuthenticatedApp = () => {
  ...
  const userInfo = index.useAuth("AuthenticatedApp", (state) => state.user);
  ...
  const userRoles = index.useAuth("AuthenticatedApp", (state) => state.user?.roles);
  React__namespace.useEffect(() => {
    if (userRoles) {
...
//# sourceMappingURL=AuthenticatedApp-9kONd5LP.js.map
