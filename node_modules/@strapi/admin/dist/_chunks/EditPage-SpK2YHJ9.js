...
const useWebhooks = require("./useWebhooks-WKx90f9K.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-_LhZe7re.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-SpK2YHJ9.js.map
