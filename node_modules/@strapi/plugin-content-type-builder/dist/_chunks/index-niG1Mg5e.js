...
const index$1 = require("./index-bEXpTdYe.js");
...
const ListView$1 = React.lazy(() => Promise.resolve().then(() => require("./ListView-OKurkWhX.js")));
const RecursivePath = () => {
...
const ListView = React.lazy(() => Promise.resolve().then(() => require("./ListView-OKurkWhX.js")));
const App = () => {
  const { formatMessage } = reactIntl.useIntl();
...
//# sourceMappingURL=index-niG1Mg5e.js.map
