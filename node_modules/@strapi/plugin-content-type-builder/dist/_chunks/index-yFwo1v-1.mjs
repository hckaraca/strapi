...
const ListView$1 = lazy(() => import("./ListView-SOqWOVnk.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-SOqWOVnk.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-yFwo1v-1.mjs.map
